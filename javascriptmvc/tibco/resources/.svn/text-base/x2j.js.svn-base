...
(function($) {
  ...
  var TOSTR = Object.prototype.toString,
    ...
    isNodeSet: function(o) { return util.isArr(o); },
  ...
  var INodeSetMethods = {
      getNodesByAttribute: function(attr, obj){
        var out = [], n = this.length, node, aval;
        if(!!n && util.isStr(attr) && util.isDef(obj)) {
          while(n--) {
      ...
      contains: function(attr, obj){
        var out = FALSE, n = this.length, node, aval;
        if(!!n && util.isStr(attr) && util.isDef(obj)) {
          while(n--) {
            node = this[n]; aval = node[attr];
      ...
      indexOf: function(){
        var out = -1, attr, obj, n = this.length, node, val;
        if(!!n) {
          switch(arguments.length) {
